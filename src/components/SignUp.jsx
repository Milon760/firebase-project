            ...
            <div className='bg-white w-full p-8 rounded-2xl shadow-xl border border-gray-200 relative'>
                ...
                <form onSubmit={formHandle} className='space-y-4'>
                    ...
                    <div className='mt-3 mb-1 relative'>
                        <label htmlFor="confirmPass" className='block text-gray-600 mb-1 font-medium'> Confirm Password : </label>
                        <div className='flex items-center'>
                            <input type={showConfirm ? 'text' : 'password'} name='confirmPass' id='confirmPass' placeholder='********' required className='w-full py-2 px-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all duration-200' />
                            {showConfirm ? <IoEyeOutline onClick={() => setShowConfirm(!showConfirm)} className='absolute right-3 cursor-pointer text-gray-500 hover:text-black' /> :
                                <IoEyeOffOutline onClick={() => setShowConfirm(!showConfirm)} className='absolute right-3 cursor-pointer text-gray-500 hover:text-black' />
                            }
                        </div>
                    </div>
                    ...
                    <div className='my-3'>
                        ...
                        <label htmlFor="check" className='ml-2 text-gray-600'> I agree to the Terms & Conditions </label>
                    </div>
                ...
                <p className='text-center text-gray-500 mt-5 font-serif'>
                    Already have an account? <a onClick={() => setModalType('login')} className='text-blue-600 font-medium px-2 hover:underline cursor-pointer'> Sign In &rarr;</a>
                </p>
            </div>
        </div>
    );
